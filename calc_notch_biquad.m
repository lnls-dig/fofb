...
%
% Function for calculating a biquad notch filter given the notch frequency (n0)
% in units of 'fs/2' (range (0, 1)) and the quality factor (Q).

function biquad = calc_notch_biquad(n0, Q)
    [b, a] = iirnotch(n0, n0/Q);
