function [Mcorr, Mss, Mdisp, Mrf] = fofb_orbit_respm_lnls1(THERING)
...
[Mcorrh, Mssh, Mdisph, Mrf] = fofb_orbit_respm(THERING, markers, 'h');

markers = struct('orbit', orbit_markers, 'corr', vcm_markers, 'ss', ss_markers, 'disp', quad_markers);
[Mcorrv, Mssv, Mdispv] = fofb_orbit_respm(THERING, markers, 'v');
